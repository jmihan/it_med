...
class KeypointDetector(BaseMLModel):
    ...
    Обнаруживает 10 ключевых точек тазобедренного сустава:
      ...
      8: L_FMP — Верхний край левого метафиза (для расчёта h/d)
      9: R_FMP — Верхний край правого метафиза (для расчёта h/d)
    """
